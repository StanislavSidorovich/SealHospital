...
const sfx = {
  ...
  boost(){ tone(380, 0.4, {type:'triangle', vol:0.08, to:1400}); noise(0.35, {vol:0.08, freq:2600, delay:0.05}); },
  grr(){ tone(150, 0.45, {type:'sawtooth', vol:0.035, to:110}); tone(180, 0.3, {type:'sawtooth', vol:0.025, to:130, delay:0.2}); },
  giggle(){ [880, 1175, 988, 1319, 1109].forEach((f,i) => tone(f, 0.08, {type:'triangle', vol:0.06, delay:i*0.08})); },
